...
//controller for registering a new user
    ...
    else if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        if($_POST["username"] == null || $_POST["password"] == null || $_POST["confirmation"] == null || $_POST["first"] == null || $_POST["last"] == null)
        {
        ...
        else if($_POST["password"] != $_POST["confirmation"]) 
        {
            ...
            if(CS50::query("INSERT IGNORE INTO users (username, hash, first, last) VALUES(?, ?, ?, ?)", $_POST["username"], password_hash($_POST["password"], PASSWORD_DEFAULT), $_POST["first"], $_POST["last"]) != 0)
            {
